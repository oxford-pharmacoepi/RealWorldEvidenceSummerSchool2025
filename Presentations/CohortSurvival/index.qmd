...
bind(survivalResultAspirin, survivalResultAspirinTuned) |> 
  tableSurvival()
```
...
```{r}
plotSurvival(bind(survivalResultAspirin, survivalResultAspirinTuned), 
...
conceptSetMI <- getCandidateCodes(cdm, keywords = "myocardial")
mi <- list("mi" = conceptSetMI$concept_id)
cdm$mi <- conceptCohort(
