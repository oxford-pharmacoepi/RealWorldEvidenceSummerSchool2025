...
-   "Your Turn" exercises - during presentations where you can practice using the package
...
duckdb is the R package we will use that can take the longest to install. Let's start installing it now.
