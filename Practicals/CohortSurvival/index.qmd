...
library(dplyr)
library(gt)
# devtools::install_github("darwin-eu-dev/CohortSurvival")
# Change after next week's release 1.1.0
...
```{r}
g2 <- plotSurvival(survivalResultAspirinTuned, colour = "outcome") + 
  ggplot2::theme(legend.position = "none") + 
  ggplot2::ggtitle("Aspirin use with 5-year washout")

plotSurvival(survivalResultAspirin) + 
  ggplot2::ggtitle("Aspirin use with infinite washout") + 
  g2
```
